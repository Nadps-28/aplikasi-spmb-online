...
<head>
    ...
    <title>@yield('title', 'Dashboard Verifikator - SPMB SMK Bakti Nusantara 666')</title>
        ...
        <div class="sidebar-menu">
            <div class="sidebar-menu-item">
                <a href="{{ route('verifikator.index') }}"
                    class="sidebar-menu-link {{ request()->routeIs('verifikator.*') ? 'active' : '' }}">
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0 fw-bold text-gray-900">@yield('page-title', 'Dashboard Verifikator')</h4>
                    <p class="text-sm text-gray-600 mb-0">@yield('page-subtitle', 'Verifikasi administrasi pendaftaran siswa baru')</p>
                </div>
            </div>
            <div class="d-flex align-items-center">
                <span class="text-muted me-3">{{ Auth::user()->name }}</span>
                <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"
                    style="width: 35px; height: 35px; background: linear-gradient(135deg, #a78bfa 0%, #8b5cf6 100%) !important;">
