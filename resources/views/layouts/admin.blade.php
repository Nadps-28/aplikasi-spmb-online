...
<head>
    ...
    <title>@yield('title', 'Admin Panel - SPMB SMK Bakti Nusantara 666')</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('dashboard') }}" class="sidebar-brand">
                ...
                <div>
                    ...
                    <div style="font-size: 0.7rem; opacity: 0.8;">Admin Panel</div>
                </div>
            </a>
        </div>
        ...
        <div class="sidebar-menu">
            ...
            <div class="sidebar-menu-item">
                <a href="{{ route('admin.monitoring') }}" class="sidebar-menu-link {{ request()->routeIs('admin.monitoring') ? 'active' : '' }}">
                    <i class="fas fa-file-alt sidebar-menu-icon"></i>
                    Monitoring Berkas
                </a>
            </div>
            <div class="sidebar-menu-item">
                <a href="{{ route('admin.peta-sebaran') }}" class="sidebar-menu-link {{ request()->routeIs('admin.peta-sebaran') ? 'active' : '' }}">
                    <i class="fas fa-map sidebar-menu-icon"></i>
                    Peta Sebaran
                </a>
            </div>
            <div class="sidebar-menu-item">
                <a href="{{ route('export.pendaftar') }}" class="sidebar-menu-link">
                    <i class="fas fa-download sidebar-menu-icon"></i>
                    Export Laporan
                </a>
            </div>
            <div class="sidebar-menu-item">
                <a href="{{ route('admin.master-data') }}" class="sidebar-menu-link {{ request()->routeIs('admin.master-data') ? 'active' : '' }}">
...
<div>
                    <h4 class="mb-0 fw-bold text-gray-900">@yield('page-title', 'Admin Panel')</h4>
                    <p class="text-sm text-gray-600 mb-0">@yield('page-subtitle', 'Kelola sistem dengan mudah dan efisien')</p>
                </div>
            </div>
            <div class="d-flex align-items-center">
