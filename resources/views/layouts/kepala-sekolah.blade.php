...
<head>
    ...
    <title>@yield('title', 'Dashboard Kepala Sekolah - SPMB SMK Bakti Nusantara 666')</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('dashboard') }}" class="sidebar-brand">
                ...
                <div>
                    ...
                    <div style="font-size: 0.7rem; opacity: 0.8;">Kepala Sekolah</div>
                </div>
            </a>
        </div>
        ...
        <div class="sidebar-menu">
            ...
            <div class="sidebar-menu-item">
                <a href="{{ route('kepala-sekolah.analytics') }}" class="sidebar-menu-link {{ request()->routeIs('kepala-sekolah.analytics') ? 'active' : '' }}">
            ...
            <div class="sidebar-menu-item">
                <a href="{{ route('kepala-sekolah.kelulusan') }}" class="sidebar-menu-link {{ request()->routeIs('kepala-sekolah.kelulusan') ? 'active' : '' }}">
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0 fw-bold text-gray-900">@yield('page-title', 'Dashboard Kepala Sekolah')</h4>
                    <p class="text-sm text-gray-600 mb-0">@yield('page-subtitle', 'Monitoring dan analisis data SPMB')</p>
                </div>
            </div>
            <div class="d-flex align-items-center">
